...
public class Login extends javax.swing.JFrame {
    ...
    private void loginbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginbuttonActionPerformed
        ...
        String loginquery = "SELECT * FROM `usuarios` WHERE `email` = ? AND `password`= ?";
        ...
        if(emailfield.getText().trim().equals("Endereço de email")){
            ...
            try {
                //(Connection conn = ConnectionFactory.obterConexão();
                  //  PreparedStatement ps = conn.prepareStatement (sql)) {
                
            ps = ConnectorFactory.conecta().prepareStatement(loginquery);
            ...
            if(rs.next()){
                // Mostrar a tela de projetos
                ProjectsPanel form = new ProjectsPanel();
